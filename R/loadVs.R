...
loadVs <- function(downSampleMcGann=TRUE){
  ...
  KaiserEtAlPts_NZGD49     <- loadKaiserEtAlVs("in/Vs/201703_allNZ/20170817_vs_allNZ_duplicatesCulled.ll")
...
loadMcGannVs <- function() {
  ...
  McGannCPT <- read.table(
    "in/Vs/20160615 Chris/McGann_cptVs30data.csv",
...
loadWotherspoonVs201711 <- function(){
  ...
  WotherspoonCSV  <- read.table(
    "in/Vs/20171123 Liam/Characterised Vs30 Canterbury_June2017_KFed.csv",
    header = TRUE, sep = "\t",
