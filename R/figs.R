...
Vs30plotBase <- ggplot() +
  xlab("Geology categories") + theme_minimal() +
  theme(
    # text = element_text(family="Sans"),
    axis.text.x = element_text(
    angle=90, vjust=0.5, hjust=0),
    panel.grid.major.y = element_line(color="gray70", size=0.2),
    panel.grid.minor.y = element_line(color="gray85", size=0.1),
...
Vs30plot <- Vs30plotBase +
  geom_jitter(data = vsprDF, # jitter representing data
              ...
              width=0.2, height=0, alpha=0.2, size=0.7) +
...
Vs30plotBase <- ggplot() +
  xlab("Terrain categories") + theme_minimal() +
  theme(
    # text = element_text(family="Sans"),
    axis.text.x = element_text(
      angle=90, vjust=0.5, hjust=0),
